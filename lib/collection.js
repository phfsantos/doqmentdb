 ...
 * @returns {*}
 */
Collection.prototype.find = function(select, from, join, where, order) {
  return _find.call(this, select, from, join, where, order, true);
};
 ...
 * @returns {*}
 */
Collection.prototype.findOne = function(select, from, join, where, order) {
  return _find.call(this, select, from, join, where, order);
};
...
Collection.prototype.findById = function(id) {
  return _find.call(this, null, null, null, { id: id });
};
...
Collection.prototype.findOneAndRemove = function(object) {
  ...
  // `Remove` operation
  function fn() {
    return using(_find.call(self, null, null, null, object), function(object) {
...
Collection.prototype.updateOne = function(sDoc, nDoc) {
  ...
  function fn() {
    return using(_find.call(self, null, null, null, sDoc), nDoc, function(doc, nDoc) {
...
Collection.prototype.findAndRemove = function(object) {
  ...
  function fn() {
    ...
    return using(_find.call(self,null,null, null, object, null, true), func, _all);
  }
...
Collection.prototype.update = function(sDoc, nDoc) {
  ...
  function fn() {
    ...
    return using(_find.call(self, "*", null, null, sDoc, null, true), func, _all);
  }
  return _callWithHooks.call(self, EVENTS.UPDATE, nDoc, pHooks, fn);
};
...
Collection.prototype.findOrCreate = function(object) {
  var ctx = this;
  return using(_find.call(this, null, null, null, object, null, true), function(result) {
...
function _findOrCreateSporc(name) {
  ...
  return self.sporcs[name] ||
    using(_getCollection.call(self), { id: SPORCS[name].id }, findSporc)
      .then(function(data) {
        return _.isEmpty(data)? manager.createSporc.call(manager, self.coll, SPORCS[name]): data;  // create sporc based const          
      })
      .then(function(sporc) {
...
function _query(obj) {
  ...
  return using(null,null,null, obj, null, Promise.props(props), manager.query.bind(manager));
}
 ...
 * @private
 */
function _find(select, from, join, where, order, many) {
  var manager = this.manager
    , schema = this._schema
    , udf = this.udf
    , q = using(_getCollection.call(this), select, from, join, where, order, function(coll) {
    return manager.find(coll, select, from, join, where, order, many, udf);
  });
