...
/**
 * @description
 * query(document|collection) by given query string
 * @param parent => database or collection
 * @param params => to return all documents/collections, omit this parameter
 * or pass an empty object({}).
 * @param {Boolean=} many
 ...
 * @returns {Promise} Array of results
 */
Manager.prototype.sql = function (parent, queryString, many, udf) {
  var client = this.client
    , type = _.isDataBase(parent) ? "Collections" : "Documents"
    , method = "query";
...
Manager.prototype.query = function (object, options) {
  var queryString = this.querybuilder.build(object)
...
Manager.prototype.findOrCreate = function (parent, object) {
    ...
    findArgs.push(this.querybuilder.build(object || parent));
    return new Promise(function (resolve, reject) {
...
Manager.prototype.from = function (from) {
  return this.querybuilder.from(from);
};

Manager.prototype.join = function (join) {
  return this.querybuilder.join(join);
};
...
Manager.prototype.order = function (order) {
  return this.querybuilder.order(order);
};
...
Manager.prototype.clear = function () {
  return this.querybuilder.clear();
};
  ...
  return function (parent, params) {
    var client = this.client
      ...
      , method = isQuery
        ? one   // query...
        : all   // read...
      , args = [parent._self].concat(isQuery ? [this.querybuilder.build(params)] : []);
    return new Promise(function (resolve, reject) {
